...
public class WorldGenFlower extends Feature<NoneFeatureConfiguration> {

    private final Block block;
    private final int chance;
    private final boolean nether;

    public WorldGenFlower(Block block, int chance, boolean nether) {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> ctx) {
        ...
        for (var i = Mth.nextInt(rand, 3, 8); i > 0; i--) {
            ...
            if (this.nether) {
                ...
                var placePos = new BlockPos(offX, levelIn.getHeight(Heightmap.Types.WORLD_SURFACE_WG, offX, offZ), offZ);
