...
public class RenderHelper {
    ...
    public static void RenderItem(PoseStack poseStack, ItemStack itemStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay, BlockPos pos, int slotRendering,
        ...
        net.minecraftforge.client.extensions.common.IClientItemExtensions.of(itemStack).getCustomRenderer().renderByItem(itemStack, ItemTransforms.TransformType.FIXED,poseStack, bufferSource, OverlayTexture.NO_OVERLAY, combinedOverlay);
