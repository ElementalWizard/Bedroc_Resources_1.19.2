package com.alexvr.bedres.worldgen.world.altar;
...
public class AltarStructure extends Structure {
    ...
    public static final Codec<AltarStructure> CODEC = RecordCodecBuilder.<AltarStructure>mapCodec(instance ->
            ...
            ).apply(instance, AltarStructure::new)).codec();
    ...
    public AltarStructure(Structure.StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!AltarStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return Registration.ALTAR_STRUCTURE.get();
    }
}
