...
import static com.alexvr.bedres.utils.compat112.jei.EventAltarCategory.RECIPE_GUI_EVENT_ALTAR;
...
public class FluxedOraclePages {
                ...
                case 1:
                    ...
                    if (player != null ){
                        ...
                        player.getCapability(PlayerAbilityProvider.PLAYER_ABILITY_CAPABILITY,null).ifPresent(h -> {
                            ...
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + Minecraft.getInstance().font.lineHeight,new TextComponent("Flux: ").append(new TextComponent(h.getFlux() +"/" + h.getMaxFlux()).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight*2),new TextComponent("Pick Tier: ").append(new TextComponent((h.getPick().equals("no") ? "NA": h.getPick())).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight * 3),new TextComponent("Axe Tier: ").append(new TextComponent((h.getAxe().equals("no") ? "NA": h.getAxe())).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight * 4),new TextComponent("Sword Tier: ").append(new TextComponent((h.getSword().equals("no") ? "NA": h.getSword())).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight * 5),new TextComponent("Shovel Tier: ").append(new TextComponent((h.getShovel().equals("no") ? "NA": h.getShovel())).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight * 6),new TextComponent("Hoe Tier: ").append(new TextComponent((h.getHoe().equals("no") ? "NA": h.getHoe())).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight * 7),new TextComponent("Mining Speed Boost: ").append(new TextComponent(String.valueOf(h.getMiningSpeedBoost())).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight * 8),new TextComponent("Jump Boost: ").append(new TextComponent(String.valueOf(h.getJumpBoost())).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                            parentScreen.renderString(parentScreen.width/2,parentScreen.height/3 + descHeight + (Minecraft.getInstance().font.lineHeight * 9),new TextComponent("Fall Damage: ").append(new TextComponent((h.takesFalldamage() ? "Taken": "Ignored")).withStyle(ChatFormatting.DARK_AQUA)),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
    ...
    public static class EventRitualRecipePage extends FluxedOraclePages{
        ...
        public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
            parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TranslatableComponent(name),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
            Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent(description)),parentScreen.width/3,parentScreen.height/3,175,DyeColor.GRAY.getTextColor());
            Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent(recipe.getIngredientList().toString())),parentScreen.width/3,(parentScreen.height/3)+ Minecraft.getInstance().font.wordWrapHeight(description,175),175,DyeColor.GRAY.getTextColor());
...
//                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Slingshot: ")
//                            .append(new TextComponent("Will Slingshot you in the direction you're aiming").withStyle(ChatFormatting.DARK_AQUA))),
//                            parentScreen.width/2,parentScreen.height/3 + descHeight + Minecraft.getInstance().font.lineHeight,175, DyeColor.WHITE.getTextColor());
                ...
                case 2:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("Slingshot: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Will Slingshot you in the direction you're aiming")),
                ...
                case 3:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("Heaven Smite: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Will strike your enemies from the heavens")),
                ...
                case 4:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("Clear Effects/Regen: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Will clear effects and give you regen")),
                            parentScreen.width/3,parentScreen.height/3,
                            175, DyeColor.GRAY.getTextColor());
                    break;
                case 5:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("Life Steal: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Will take health from the enemy to heal and saturate you")),
                            parentScreen.width/3,parentScreen.height/3,
                            175, DyeColor.GRAY.getTextColor());
                    break;
                case 6:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("TBD: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("TBD")),
                            parentScreen.width/3,parentScreen.height/3,
                            175, DyeColor.GRAY.getTextColor());
                    break;
                case 7:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("Poison: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Will incrementally make the enemy most near you to get a stronger poison")),
                            parentScreen.width/3,parentScreen.height/3,
                            175, DyeColor.GRAY.getTextColor());
                    break;
                case 8:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("Green Thumb: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Right click will simulate bonemeal the block selected and Shift RC will force random ticks on a 3x3 area where youre aiming ")),
                            parentScreen.width/3,parentScreen.height/3,
                            175, DyeColor.GRAY.getTextColor());
                    break;
                case 9:
                    ...
                    parentScreen.renderString(parentScreen.width/2,parentScreen.height/4,new TextComponent("Light Projectile: "),pPoseStack,pPartialTick,true, DyeColor.WHITE.getTextColor());
                    Minecraft.getInstance().font.drawWordWrap(FormattedText.composite(new TextComponent("Will shoot out a projectile that will create a light block on collision with block or light entity on fire.")),
                            parentScreen.width/3,parentScreen.height/3,
                            175, DyeColor.GRAY.getTextColor());
                    break;
            }
